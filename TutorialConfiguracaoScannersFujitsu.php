...
<body>
        ...
        <div class="span8">
          <div class="row">
            ...
            <div class="span6 offset2">
              <h1>Tutorial para a configuração do <strong>software para os Scanners Fujitsu</strong></h1>
              <div class="head-info">
  ...
  <div id="content">
    <div class="container">
          <div class="row">
            <div class="span12">
              <h2>Configuração do software <strong>para os Scanners Fujitsu</strong></h2>
            </div>
