...
<body>
        ...
        <div class="span8">
          <div class="row">
            ...
            <div class="span6 offset2">
              <h1>Portaria de Institucionalização <strong>do Processo Eletrônico</strong></h1>
              <div class="head-info">
                Portaria Nº 26 de 2016 - Institui o Sistema Eletrônico de Informações (SEI) como sistema oficial de gestão de processos e documentos do Ministério
                da Cultura, define normas, rotinas e procedimentos
                de instrução do processo eletrônico,
  ...
  <div id="content">
    <div class="container">
          <div class="row">
            <div class="span12">
              <h2>Portaria do <strong>Processo Eletrônico</strong></h2>
            </div>

            <div class="span9">

              <iframe src="arquivos/Portaria26.pdf" width="880" height="700"></iframe>
