...
<body>
        ...
        <div class="span8">
          <div class="row">
            ...
            <div class="span6 offset2">
              <h1>Manual do Usuário <strong>SEI - Sistema Eletrônico de Informações</strong></h1>
              <div class="head-info">
  ...
  <div id="content">
    <div class="container">
          <div class="row">
            <div class="span12">
              <h2>Manual do  <strong>Usuário</strong></h2>
            </div>

            <div class="span9">

              <iframe src="arquivos/manual_sei.pdf" width="880" height="700"></iframe>
