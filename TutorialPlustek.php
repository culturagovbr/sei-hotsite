...
<body>
        ...
        <div class="span8">
          <div class="row">
            ...
            <div class="span6 offset2">
              <h1>Tutorial de Utilização do Scanner <strong>Plustek</strong></h1>
              <div class="head-info">
  ...
  <div id="content">
    <div class="container">
          <div class="row">
            <div class="span12">
              <h2>Tutorial para  <strong>Plustek</strong></h2>
            </div>
          ...
          <!--  Fim do Side Bar -->
              ...
              <div class="row">
                ...
                <div class="span8">
                  ...
                  <div class="post-d-info">
                    <a href="TutorialSEI.php"><h3>5. Após o scanneamento, siga os passos do <strong>tutorial Paper Port.</strong> </h3></a>
