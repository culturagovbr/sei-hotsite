        ...
        <div class="span8">
          <div class="row">
            ...
            <div class="span6 offset2">
              <h1>Confira vídeo do João Brant sobre a importância <strong>do SEI para o Ministério da Cultura</strong></h1>
              <div class="head-info">
                <iframe width="700" height="480" src="https://www.youtube.com/embed/jeqsITiq-24" frameborder="0" allowfullscreen></iframe>
                <br><br><br><br>
              </div>   
            </div>  
